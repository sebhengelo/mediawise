...
class WPLMS_tips{
			...
			foreach($this->settings as $key=>$setting){
				switch($key){
					...
					case 'quiz_passing_score':
						...
						//add_filter('wplms_next_unit_access_start',array($this,'wplms_next_access_start'),10,2);
						...
						add_action('wplms_front_end_save_quiz_settings_extras',array($this,'save_quiz_passing_score'),10,1);
					break;
	...
	function coming_soon_display($credits,$course_id){
		$coming_soon = get_post_meta($course_id,'vibe_coming_soon',true);
		if(vibe_validate($coming_soon)){
			return __('COMING SOON','vibe-customtypes');
		}
		return $credits;
	}
