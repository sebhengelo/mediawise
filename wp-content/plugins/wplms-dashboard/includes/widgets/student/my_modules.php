      ...
      echo '<div id="tab-mycourses" class="tab-pane">';
        ...
        if(count($courses)){
          ...
          foreach($courses as $course){
              echo '<li><a href="'.get_permalink($course->courseID).'">'.get_the_title($course->courseID).'</a></li>';
          }
          echo '</ul>';  
        }else{
      ...
      echo '<div id="tab-myquizzes" class="tab-pane">';
        ...
        if(count($quizzes)){
          ...
          foreach($quizzes as $quiz){
              echo '<li><a href="'.get_permalink($quiz->ID).'">'.get_the_title($quiz->ID).'</a></li>';
          }
          echo '</ul>';  
        }else{
       ...
       echo '<div id="tab-myassignments" class="tab-pane">';
        ...
        if(count($assignments)){
          ...
          foreach($assignments as $assignment){
              echo '<li><a href="'.get_permalink($assignment->ID).'">'.get_the_title($assignment->ID).'</a></li>';
          }
          echo '</ul>';  
        }else{
      ...
      echo '<div id="tab-myunits" class="tab-pane">';
        ...
        if(count($units)){
          ...
          foreach($units as $unit){
              echo '<li><a href="'.get_permalink($unit->ID).'">'.get_the_title($unit->ID).'</a></li>';
          }
          echo '</ul>';  
        }else{
      ...
      echo '<div id="tab-mydownloads" class="tab-pane">';
        ...
        if(count($downloads)){
          ...
          foreach($downloads as $download){
              echo '<li><a href="'.wp_get_attachment_url($download->ID).'" target="_blank">'.get_the_title($download->ID).'</a></li>';
          }
          echo '</ul>';  
        }else{
