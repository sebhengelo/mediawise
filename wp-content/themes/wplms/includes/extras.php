...
add_filter('manage_pages_columns', 'wplms_posts_columns_id', 5);
add_action('manage_pages_custom_column','wplms_posts_custom_id_columns', 5, 2);
add_filter('manage_posts_columns', 'wplms_posts_columns_id', 5);
add_action('manage_posts_custom_column', 'wplms_posts_custom_id_columns', 5, 2);
