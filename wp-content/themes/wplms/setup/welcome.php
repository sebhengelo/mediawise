	...
	public function about_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						<h4><?php _e( '23 Bugs fixes and Updates', 'vibe' ); ?></h4>
						<p><?php _e( 'We fixed some pending issues. Refer to change log for complete list of issues/bugs fixed in the update.', 'vibe' ); ?></p>
						<a href="http://support.vibethemes.com/solution/articles/1000178998-1-9-4" class="button"><?php _e( 'Check issue log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4><?php _e( 'Features Update', 'vibe' ); ?></h4>
						<p><?php _e( 'We focussed on small features in this update. 8 new features were added. ', 'vibe' ); ?></p>
						<a href="http://support.vibethemes.com/solution/articles/1000178998-1-9-4" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Notes & Discussion styles', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/notes_style.jpg'; ?>" /></p>
						<a href="http://support.vibethemes.com/solution/articles/1000178974-simple-notes-and-discussion-" class="button" target="_blank"><?php _e('Tutorial','vibe'); ?></a>
					</div>
					<div>
						<h4><?php _e( 'Section wise drip feed', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/drip_feed.jpg'; ?>" /></p>
						<a href="http://support.vibethemes.com/solution/articles/1000179014-section-drip-feed" class="button" target="_blank"><?php _e('Tutorial','vibe'); ?></a>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'PDF Certificates', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/certificate_pdf.jpg'; ?>" /></p>
						<a href="http://support.vibethemes.com/solution/articles/1000179013-pdf-certificates" class="button" target="_blank"><?php _e('Tutorial','vibe'); ?></a>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Quiz Passing score', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/passing_score.jpg'; ?>" /></p>
						<a href="http://support.vibethemes.com/solution/articles/1000179016-quiz-passing-score" class="button" target="_blank"><?php _e('Tutorial','vibe'); ?></a>
					</div>
					<div>
						<h4><?php _e( 'Quiz Negative Marking', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/negative_marking.jpg'; ?>" /></p>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Password Strength meter', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/password.gif'; ?>" /></p>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'OneInstructor Theme', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/oneinstructor.jpg'; ?>" /></p>
						<a href="http://support.vibethemes.com/solution/categories/1000126528/folders/1000213471/articles/1000178774-oneinstructor-one-click-install"><?php _e( 'Video Tutorial','vibe'); ?></a>
					</div>
					<div>
						<h4><?php _e( 'OneCourse Theme', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/onecourse.jpg'; ?>" /></p>
						<a href="http://support.vibethemes.com/solution/categories/1000126528/folders/1000213471/articles/1000178775-one-course-theme-one-click-install"><?php _e( 'Video Tutorial','vibe'); ?></a>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Coming soon courses', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/comingsoon.jpg'; ?>" /></p>
					</div>
				</div>
			</div>
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						<h4><?php _e( 'My Modules Dashboard Widget', 'vibe' ); ?></h4>
						<p><?php _e( 'This is a new dashboard widget which shows the user her courses, quizzes, units, assignments, downloads etc in a list format.', 'vibe' ); ?></p>
